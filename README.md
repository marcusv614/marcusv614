...
<h4 align="center">- ⚔️ Character Sheet: Marcus Pinheiro<br><br>- 🛡️ Class: Backend Developer | Java & Spring Boot<br>- 📍 Origin: Manaus, AM - Brazil<br>- 📜 Quest: Master the art of scalable systems and clean code.<br>- 🛠️ Current Gear: Java & Spring Boot (The Heavy Armor), React, MySQL & PostgreSQL.<br><br> ⚒️ Technical Skill Tree<br>Backend: Java, Spring Boot, PostgreSQL, MySQL<br>Frontend: React, HTML5, CSS3<br>Tools: Git, GitHub, Docker, Linux (Terminal Wizard)</h4>
